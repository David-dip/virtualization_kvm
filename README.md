...
**KVM Environment Manager** — это CLI-приложение для управления виртуальными машинами на базе гипервизора KVM. Приложение обеспечивает полную воспроизводимость инфраструктуры: все конфигурации хранятся в PostgreSQL, а перенос на другой хост занимает几分钟.
